...
| 1 | `inception` | New project from scratch | `/.agentic-sdlc/brd.md` |
| 2 | `design-system` | UI project | `/.agentic-sdlc/design-system.md` |
| 3 | `tech-architecture` | Before any code | `/.agentic-sdlc/tech-architecture.md`, ADRs |
| 3a | `coding-constitution` | Within tech-architecture | `/.agentic-sdlc/coding-constitution.md` |
| 4 | `implementation-planning` | After architecture approved | `/.agentic-sdlc/implementation-plan.md` |
| 5 | `story-breakdown` | Before implementation | `/.agentic-sdlc/task-graph.md` |
| 6 | `implementation` | Writing code | Code + tests |
| 7 | `critical-review` | After implementation, per story | `/.agentic-sdlc/critical-review.md` |
| 8 | `testing` | After review passes | `/.agentic-sdlc/test-plan.md` |
| 9 | `code-review` | Before merge | Review checklist |
| 10 | `retrospective` | Project complete | `/.agentic-sdlc/retrospective.md` |

## Workflow 2: Brownfield

| Order | Skill | Trigger | Key Output |
|---|---|---|---|
| 0 | `context-harvest` | Unfamiliar existing codebase | `/.agentic-sdlc/existing-system.md` |
...
| 3 | `brownfield-tech-plan` | Story needs tech plan | `/.agentic-sdlc/tech-plan-[STORY-ID].md` |
