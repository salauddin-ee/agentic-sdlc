...
### ✅ DONE 8. `data-domain.md` never written (commit `b330f78`)
...
### ✅ DONE 9. `task-graph.md` and EPIC manifest never written (commit `b330f78`)
...
### ✅ DONE 10. Workspace file never created during implementation (commit `b330f78`)
...
### ✅ DONE 11. BRD status never updated from "Draft" to "Approved" (commits `59479b4`, `fcb4c54`)
...
### ✅ DONE 12. ADR files never written to `docs/architecture/adrs/` (commit `c685019`)
...
### ✅ DONE 13. Story identity drift is not caught (commits `291048e`, `fcb4c54`)
...
### ✅ DONE 14. Architecture and context claims can drift from repository reality (commit `1deeb6d`)
...
### ✅ DONE 15. Retrospective requirement fidelity can be declared without evidence (commit `0aeac52`)
...
### ✅ DONE 16. Story status is marked `DONE` too early (commits `59479b4`, `fcb4c54`)
...
### ✅ DONE 17. Canonical task graph can go stale during implementation (commits `291048e`, `fcb4c54`)
