...
Each planning/documentation stage (inception, design-system, ui-mockup-gate, tech-architecture, implementation-planning, story-breakdown) follows this pattern:
...
1. Create branch:
   ...
   # e.g. docs/inception, docs/ui-mockup-gate, docs/tech-architecture
